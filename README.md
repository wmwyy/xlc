...
**B.3.1 海漫末端的河床冲刷深度（B.3.1）：**
\\\
dm = 1.1 \frac{qm}{[v0]} - hm
\\\
...
**B.3.2 上游护底首端的河床冲刷深度（B.3.2）：**
\\\
d'm = 0.8 \frac{q'm}{[v0]} - h'm
\\\

其中：
- d'm: 上游护底首端河床冲刷深度 (m)
- q'm: 上游护底首端单宽流量 (m³/(s·m))
- h'm: 上游护底首端河床水深 (m)
